...
const InvoiceContractor = () => {
  ...
  const handleGetTask = () => {
    ...
    axios({
      method: "get",
      url: `http://localhost:5000/api/getTasks?date=${formatDate}&organization=${
        client.split(",")[0]
      }`,
      headers: {
  ...
  const getPendingInvoice = () => {
    axios({
      method: "get",
      url: `http://localhost:5000/api/getpendinginvoiceforcontractor?contractorId=${contractorId}&page=${page2}`,
      headers: {
        Authorization: `Bearer ${usertoken}`,
      },
    })
  ...
  const getApprovedInvoice = () => {
    axios({
      method: "get",
      url: `http://localhost:5000/api/getinvoicesforcontractor?contractorId=${contractorId}&page=${page}`,
      headers: {
        Authorization: `Bearer ${usertoken}`,
      },
    })
  ...
  const handleInvoiceSubmit = (e) => {
    ...
    axios({
      method: "post",
      url: `http://localhost:5000/api/createinvoiceapproval`,
      headers: {
        Authorization: `Bearer ${usertoken}`,
      },
      data: formData,
      ...
      <div className="approved-invoice">
        ...
        <Dialog
              ...
              >
                ...
                <img
                  src={`http://localhost:5000${imgLink.split("public")[1]}`}
                />
              </Dialog>
      </div>
